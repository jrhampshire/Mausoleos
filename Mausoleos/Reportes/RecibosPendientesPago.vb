...
Public Class RecibosPendientesPago
...
#End Region
    ...
    Sub Carga_Datos()
        Try
            SQL_Str = "Declare @TablaTemp Table(Id_Recibo int, Estado_Actual nvarchar(100), Descripcion nvarchar(MAX), Contrato int, Cliente nvarchar(MAX))" &
                " Insert Into @TablaTemp Select Id_Recibo, Estado_Actual, Descripcion ,0,0 from Recibos Where Estado_Actual = 'Recibo Generado'" &
                " Declare @Recibo int" &
                ...
                " Close Recibos" &
                " Deallocate Recibos" &
                " Select Id_Recibo as Recibo, Estado_Actual as Estado, Descripcion as Concepto, Contrato, Cliente from @TablaTemp"
            Cx.Open()
    ...
    Private Sub Button_ExportaExcell_Click(sender As Object, e As EventArgs) Handles Button_ExportaExcell.Click
        ...
        Try
            ...
            xlsheet.Range("A2").Value = "Recibos Generados Pendientes de Pago"
            ...
            xlsheet.Cells(6, 1).Formula = "Recibo"
            xlsheet.Cells(6, 2).Formula = "Estado"
            xlsheet.Cells(6, 3).Formula = "Concepto"
            xlsheet.Cells(6, 4).Formula = "Contrato"
            xlsheet.Cells(6, 5).Formula = "Cliente"
            xlsheet.Range("A6:E6").Font.Bold = True
            xlsheet.Range("A6:E6").Interior.ColorIndex = 16
            xlsheet.Range("A6:E6").Font.Size = 11
            xlsheet.Range("A6:E6").Borders().Color = 0
            xlsheet.Range("A6:E6").Borders().LineStyle = Excel.XlLineStyle.xlContinuous
            xlsheet.Range("A6:E6").Borders().Weight = 2
            xlsheet.Range("A6:E6").HorizontalAlignment = Excel.XlHAlign.xlHAlignCenter
            ...
            xlsheet.Range("E1").EntireColumn.ColumnWidth = 35
    ...
    Private Sub RecibosPendientesPago_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Carga_Datos()
    End Sub
End Class