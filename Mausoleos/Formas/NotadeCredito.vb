...
'Imports SiFact2014.JavaScience
...
#Region "Factura"
    Private Sub Button_Aceptar_Click(sender As Object, e As EventArgs) Handles Button_Aceptar.Click
        Me.Button_Aceptar.Enabled = False
        ...
        Using cx As New SqlConnection(CxSettings.ConnectionString)
            Sql_Str = "Select Max(CAST(folio as int)) from Comprobante Where Serie = 'B'; Select Serie from Series"
            Try
                cx.Open()
                Dim Cmd As New SqlCommand(Sql_Str, cx)
                Cmd.CommandType = CommandType.Text
        ...
        With CFDs
            .Comprobante(VersionCFD.CFDv3_2, Folio_Actual, FormatDateTime(Now, DateFormat.GeneralDate), Condiciones_Pago _
                          , Me.Label_Gran_Subtotal.Text, Me.Label_Gran_Total.Text, clsCFDIx.ComprobanteTipoDeComprobante.egreso, "99 Otros" _
                          , clEmpresa.pais, "B", _TipoDeCambio, Condiciones_Pago, _Descuento, _motivoDescuento, "M.N." _
                          , "", _FolioFiscalOriginal, _SerieFolioFiscalOrig, _FechaFolioFiscalOrig)
        ...
        Dim _NombreArchivo As String = RutaSrv + "\Facturas\CFDI_B-" & Folio_Actual.ToString & ".xml"
        ...
        If Guardar_Folio = True Then
            ...
            PDF_File.LlenaFormatoCfdiNotaCredito(_NombreArchivo, clEmpresa.Logotipo, True, clsCFDIx.clsFormatoImpresion.eNavegador.iexplore,
            ...
            Using cx As New SqlConnection(CxSettings.ConnectionString)
                Try
                    ...
                    Cmd.Parameters.AddWithValue("@tipoDeComprobante", "Egreso")
                    Cmd.Parameters.AddWithValue("@metodoDePago", "99 Otros")
        ...
        MsgBox("Su Nota de Credito ha sido Generada", MsgBoxStyle.Information)


        Me.Button_Aceptar.Enabled = True
        Me.Close()
    End Sub
#End Region
