...
Public Class Listado_Servicios
...
#End Region
    ...
    Sub Guarda()
        ...
        Else
            Try
                ...
                '////////////////////////////////////////////////////
                Sql_str = "Select * from Servicios where Servicio = @Pais"
                ...
                Cx.Close()
                If Tot >= 1 Then
                    MessageBox.Show("Ya existe este Servicio en la base de datos", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
                    Exit Sub
                End If
                '////////////////////////////////////////////////////
                ...
                If Cx.State = ConnectionState.Closed Then
                    Cx.Open()
                End If
                Sql_str = "Insert into Servicios (Servicio) Values(@Pais)"
    ...
    End Sub
    Sub Cargar_Paises()
        Dim SQL_Str As String = "Select * from Servicios order by Servicio"
        Try
            Dim DA As New SqlDataAdapter(SQL_Str, Cx)
            Dim DS As New DataSet
            DA.Fill(DS, "Servicios")
            With Me.ListBox_Paises
                .DataSource = DS.Tables("Servicios")
    ...
    Private Sub Btn_Borrar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Btn_Borrar.Click
        ...
        If 0 = 0 Then
            MessageBox.Show("Debe de seleccionar un Servicio", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
            Exit Sub
        Else
            Try
                Cx.Open()
                Dim SQL_Str As String = "Delete from Servicios where id_Servicio = @Pais"
                Dim Cmd_Borra As SqlCommand = New SqlCommand(SQL_Str, Cx)
                Cmd_Borra.CommandType = CommandType.Text
                Cmd_Borra.Parameters.AddWithValue("@Pais", 0)
